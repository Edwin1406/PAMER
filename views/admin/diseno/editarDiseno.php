    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Ingrese los datos para editar el diseño</p>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">EDITAR DISEÑO</h4>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="POST" action="/admin/diseno/editarDiseno?id=<?php echo $diseno->id; ?>" enctype="multipart/form-data">
                                <div class="row">
